...
namespace mrtn.StatelessDesignerEditor
{
    ...
    //     - An empty stateless file in the same directory as NewFileItems.vsdir. In
    //       our case we chose StateMachine.stateless.stateless. Note this file name appears in Editor.vsdir
    ...
    //          - "StateMachine.stateless" - This is the base file name. New files will initially
    //             be named as StateMachine.stateless1.stateless, StateMachine.stateless2.stateless... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    StateMachine.stateless.stateless|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - StateMachine.stateless.stateless - our empty stateless file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".stateless";
        ...
        #region Fields
        private StatelessDesignerEditorPackage myPackage;
        ...
        public EditorPane(StatelessDesignerEditorPackage package)
            : base(null)
        {
            PrivateInit(package);
        }
        ...
        /// <summary>
        /// Initialization routine for the Editor. Loads the list of properties for the stateless document 
        /// which will show up in the properties window 
        /// </summary>
        /// <param name="package"></param>
        private void PrivateInit(StatelessDesignerEditorPackage package)
        {
            myPackage = package;
            loading = false;
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidStatelessDesignerEditorCmdSet, PkgCmdIDList.IDMX_RTF);
        ...
        {
            pClassID = GuidList.guidStatelessDesignerEditorEditorFactory;
            return VSConstants.S_OK;
        }
