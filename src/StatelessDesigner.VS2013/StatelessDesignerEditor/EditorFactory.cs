...
namespace mrtn.StatelessDesignerEditor
{
    ...
    /// </summary>
    [Guid(GuidList.guidStatelessDesignerEditorEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private StatelessDesignerEditorPackage editorPackage;
        private ServiceProvider vsServiceProvider;


        public EditorFactory(StatelessDesignerEditorPackage package)
        {
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidStatelessDesignerEditorEditorFactory;
            pgrfCDW = 0;
