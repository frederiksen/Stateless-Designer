...
namespace mrtn.StatelessDesignerEditor
{
    ...
    [ProvideEditorExtension(typeof(EditorFactory), ".stateless", 50, 
              ProjectGuid = "{A2FE74E1-B743-11d0-AE1A-00A0C90FFFC3}", 
              TemplateDir = "Templates", 
              NameResourceID = 105,
              DefaultName = "Stateless Designer")]
    [ProvideKeyBindingTable(GuidList.guidStatelessDesignerEditorEditorFactoryString, 102)]
    ...
    [Guid(GuidList.guidStatelessDesignerEditorPkgString)]
    public sealed class StatelessDesignerEditorPackage : Package
    {
        /// <summary>
        ...
        /// </summary>
        public StatelessDesignerEditorPackage()
        {
